...
Dateien und Verzeichnisse die mit „.“ beginnen sind versteckt. Man kann sie anzeigen, wenn man ls mit dem Parameter „-a“ benutzt.
...
\lstinline$ls -lBh ~/$. ls ist der ausgeführte Befehl, -l, -B und -h sind Parameter für das Programm ls und \lstinline$~/$ der Pfad zum Verzeichnis, dessen Dateien ls auflisten soll. \lstinline$~$ ist eine abgekürzte Schreibweise für das eigene home-Verzeichnis.
...
\item sieh nach wie spät es ist mit 'date' und rufe mit 'man date' die Manpage zu 'date' auf
